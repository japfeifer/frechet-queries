% Allocate almost all GPU memory to the 18 coco joints, and very little to the hands
...
MSASLImpVid(aslDir,aslFile,resDir,resFile,resDir2,openposeDir,vidDir,maxClassId,netRes,handRes);
