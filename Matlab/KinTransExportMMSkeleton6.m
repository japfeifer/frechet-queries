...
for i=1:size(currSeqSet,1) % for each sequence do
    ...
    for j = 1:numFrame  % for each frame do
        ...
        currText = '                "keypoints": [';
        currText = [currText,'[',num2str(currSeq(j,NOSE(1))),', ',num2str(currSeq(j,NOSE(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,LEYE(1))),', ',num2str(currSeq(j,LEYE(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,REYE(1))),', ',num2str(currSeq(j,REYE(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,LEAR(1))),', ',num2str(currSeq(j,LEAR(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,REAR(1))),', ',num2str(currSeq(j,REAR(2))),', 0], '];
        ...
        currText = [currText,'[',num2str(currSeq(j,LHIP(1))),', ',num2str(currSeq(j,LHIP(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,RHIP(1))),', ',num2str(currSeq(j,RHIP(2))),', 0.9], '];
        currText = [currText,'[',num2str(currSeq(j,LKNE(1))),', ',num2str(currSeq(j,LKNE(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,RKNE(1))),', ',num2str(currSeq(j,RKNE(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,LANK(1))),', ',num2str(currSeq(j,LANK(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,RANK(1))),', ',num2str(currSeq(j,RANK(2))),', 0], '];
