...
function seq = MHADNormalizeSeq(seq,seqNormalCurr)
    ...
    % (0) only extract key joint info
    seq = [seq(:,OLD_TORS) seq(:,OLD_NECK) seq(:,OLD_HEAD) seq(:,OLD_RSHO) ...
           seq(:,OLD_RELB) seq(:,OLD_RHND) seq(:,OLD_LSHO) seq(:,OLD_LELB) ...
           seq(:,OLD_LHND) seq(:,OLD_RHIP) seq(:,OLD_RKNE) seq(:,OLD_RFOT) ...
           seq(:,OLD_LHIP) seq(:,OLD_LKNE) seq(:,OLD_LFOT)];
    ...
    if seqNormalCurr(1,1) == 1
        ...
        seq = [seq(:,TORS)+transPoint seq(:,NECK)+transPoint ...
               seq(:,HEAD)+transPoint seq(:,RSHO)+transPoint ...
               seq(:,RELB)+transPoint seq(:,RHND)+transPoint ...
               seq(:,LSHO)+transPoint seq(:,LELB)+transPoint ...
               seq(:,LHND)+transPoint seq(:,RHIP)+transPoint ...
               seq(:,RKNE)+transPoint seq(:,RFOT)+transPoint ...
