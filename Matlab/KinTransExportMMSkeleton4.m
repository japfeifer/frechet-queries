...
for i=1:size(currSeqSet,1) % for each sequence do
    ...
    for j = 1:numFrame  % for each frame do
        ...
        currText = '                "keypoints": [';
        currText = [currText,'[',num2str(currSeq(j,HEAD(1))),', ',num2str(currSeq(j,HEAD(2))),', 0], '];
        ...
        currText = [currText,'[',num2str(currSeq(j,RFOT(1))),', ',num2str(currSeq(j,RFOT(2))),', 0], '];
        ...
        currText = [currText,'[',num2str(currSeq(j,LFOT(1))),', ',num2str(currSeq(j,LFOT(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,RTHD(1))),', ',num2str(currSeq(j,RTHD(2))),', 0], '];
        currText = [currText,'[',num2str(currSeq(j,LTHD(1))),', ',num2str(currSeq(j,LTHD(2))),', 0], '];
