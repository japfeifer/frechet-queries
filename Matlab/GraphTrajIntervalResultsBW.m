...
for i=1:szS1
    if s1StatBnd(i,3) < SLB
        plot([s1StatBnd(i,2) s1StatBnd(i,3)],[szS1-i+1 szS1-i+1],'o','linewidth',3,'color',[0,0,0],...
                'LineStyle','-','MarkerSize',1,'MarkerEdgeColor',[0,0,0]);
    else
        plot([s1StatBnd(i,2) s1StatBnd(i,3)],[szS1-i+1 szS1-i+1],'o-k','linewidth',3,'MarkerSize',1,'color',[0.7,0.7,0.7],'LineStyle','-');
    end
end
i=kNum;
plot([s1StatBnd(i,2) s1StatBnd(i,2)],[szS1-i+1 szS1],'linewidth',2,'color',[0.1,0.1,0.1],'LineStyle',':');
