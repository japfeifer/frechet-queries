...
for i=1:size(currSeqSet,1) % for each sequence do
    ...
    for j = 1:numFrame  % for each frame do
        ...
        currText = [currText,num2str(round(HEAD(1),3),'%.3f'),', ',num2str(round(HEAD(2),3),'%.3f'),', '];
        ...
        currText = [currText,num2str(round(RHIP(1),3),'%.3f'),', ',num2str(round(RHIP(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(RKNE(1),3),'%.3f'),', ',num2str(round(RKNE(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(RFOT(1),3),'%.3f'),', ',num2str(round(RFOT(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(LHIP(1),3),'%.3f'),', ',num2str(round(LHIP(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(LKNE(1),3),'%.3f'),', ',num2str(round(LKNE(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(LFOT(1),3),'%.3f'),', ',num2str(round(LFOT(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(RTHD(1),3),'%.3f'),', ',num2str(round(RTHD(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(LTHD(1),3),'%.3f'),', ',num2str(round(LTHD(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(REAR(1),3),'%.3f'),', ',num2str(round(REAR(2),3),'%.3f'),', '];
        currText = [currText,num2str(round(LEAR(1),3),'%.3f'),', ',num2str(round(LEAR(2),3),'%.3f'),'], '];
