...
*
 ** compile with:
 * mex -v COMPFLAGS='$COMPFLAGS -std=c++11' -DNVIS -DNCERTIFY FrechetDPBringmann2.cpp curve.cpp filter.cpp frechet_light.cpp frechet_naive.cpp geometry_basics.cpp 
*/
...
//     void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
     void operator()(ArgumentList outputs, ArgumentList inputs) {
        ...
        bool resFlg = FrechetDPBringmann2(curve1, curve2,leash_dist);
        outputs[0] = factory.createScalar(resFlg);
    }

    double FrechetDPBringmann2(matlab::data::TypedArray<double>& inCurve1, matlab::data::TypedArray<double>& inCurve2, double leash_dist) {
        ...
        bool dp_flg = frechet->lessThan(leash_dist, bringCurve1, bringCurve2);
        
//         stream << "box count: " << frechet->getNumberOfBoxes() << std::endl;
        stream << frechet->getNumberOfBoxes() << std::endl;
