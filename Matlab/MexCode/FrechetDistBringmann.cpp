...
*
 ** compile with: 
 * mex -v COMPFLAGS='$COMPFLAGS -std=c++11' -DNVIS -DNCERTIFY FrechetDistBringmann.cpp curve.cpp filter.cpp frechet_light.cpp frechet_naive.cpp geometry_basics.cpp 
*/
...
//     void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
     void operator()(ArgumentList outputs, ArgumentList inputs) {
        ...
        double resDist = FrechetDistBringmann(curve1, curve2);
        outputs[0] = factory.createScalar(resDist);
    }

    double FrechetDistBringmann(matlab::data::TypedArray<double>& inCurve1, matlab::data::TypedArray<double>& inCurve2) {
...
//         displayOnMATLAB(stream);
        ...
        double resDist = frechet->calcDistance(bringCurve1, bringCurve2);
