...
for i=1:szS1
    if i <= kNum
        plot([s1StatBnd(i,2) s1StatBnd(i,3)],[szS1-i+1 szS1-i+1],'o-k','linewidth',3,'MarkerSize',1,'color',[0,0,0],'LineStyle','-');
    end
    if i == kNum
        SUB = s1StatBnd(i,3);
    elseif i > kNum
        if s1StatBnd(i,2) > SUB
            plot([s1StatBnd(i,2) s1StatBnd(i,3)],[szS1-i+1 szS1-i+1],'o','linewidth',3,'color',[0.7,0.7,0.7],...
                'LineStyle','-','MarkerSize',1,'MarkerEdgeColor',[0.7,0.7,0.7]);
        else
            plot([s1StatBnd(i,2) s1StatBnd(i,3)],[szS1-i+1 szS1-i+1],'o-k','linewidth',3,'MarkerSize',1,'color',[0,0,0],'LineStyle','-');
        end
    end
...
i = kNum;
plot([s1StatBnd(i,3) s1StatBnd(i,3)],[szS1-i+1 1],'linewidth',2,'color',[0.1,0.1,0.1],'LineStyle',':');
