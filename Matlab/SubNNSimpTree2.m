...
function SubNNSimpTree2(Qid,level,sIdx,eIdx,typeQ,eVal,bestDistUB,graphFlg)
    ...
    if graphFlg == 1
        GraphSubNN2(Qid,level,1,subStr);
    end
