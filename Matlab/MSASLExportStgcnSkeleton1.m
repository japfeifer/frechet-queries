    ...
    for ii = 1:repeatNum
        ...
        for j = 1:numFrame  % for each frame do
            ...
            currText = ['{"pose": [' ...
                       ...
                       sprintf('%.3f',round(currSeq(j, SHO(1)),3)),', ',sprintf('%.3f',round(currSeq(j, SHO(2)),3)),', ' ...
                       ...
                       sprintf('%.3f',round(currSeq(j,RHND(1)),3)),', ',sprintf('%.3f',round(currSeq(j,RHND(2)),3)),', ' ...
                       ...
                       sprintf('%.3f',round(currSeq(j,LHND(1)),3)),', ',sprintf('%.3f',round(currSeq(j,LHND(2)),3)),', ' ...
                       ...
                       sprintf('%.3f',round(currSeq(j,RHED(1)),3)),', ',sprintf('%.3f',round(currSeq(j,RHED(2)),3)),', ' ...
                       sprintf('%.3f',round(currSeq(j,LHED(1)),3)),', ',sprintf('%.3f',round(currSeq(j,LHED(2)),3)),', ' ...
