...
scriptName = 'ProcessHMNTURGBD60_XSub_SD_DTW_opt_multi_B_small';
...
numPredictor = 0;
numLearner = 100;
featureSetNum = 1;  % featureSetNum = 2;
normDistCurr = 0;
kCurr = 0;
numTrainCurr = -1;
trajFeatureCurr = [12];
...
trainSampleCurr = 6;  % trainSampleCurr = 6;
testSampleCurr = 4;  % testSampleCurr = 4;
