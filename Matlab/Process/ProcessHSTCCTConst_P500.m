...
scriptName = 'ProcessHSTCCTConst_P500';
...
dataList = ["FootballData"; ...
            ...
            "SyntheticLow"; ...
            "SyntheticHigh"];
scrList = ["MatlabData/HSTFootballDataSz500Meth3.mat"; ...
           "MatlabData/HSTPigeonHomingDataSz500Meth3.mat"; ...
...
%     disp(['Construct Approx Radii CCT time (s): ',num2str(t)]);
    ...
    save(fileNameHST,'inP','inpTrajErr','inpTrajErrF','inpTrajPtr','inpTrajSz','inpTrajVert','inpLen','queryStrData','inpTrajRad','trajStrData','clusterTrajNode','clusterNode','simpLevelCCT','-v7.3');
end
