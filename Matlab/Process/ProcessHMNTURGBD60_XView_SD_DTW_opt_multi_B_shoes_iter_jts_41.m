...
scriptName = 'ProcessHMNTURGBD60_XView_SD_DTW_opt_multi_B_shoes_iter_jts_41';
...
% trajFeatureCurr = [38 39 40 41 1081]; % feat temp for only class id 41, more canon subskel
