...
scriptName = 'ProcessHMNTURGBD60_XView_SD_DTW_opt_multi_B_shoes_iter_jts_56';
...
kCurr = 0;
numTrainCurr = -1;
% trajFeatureCurr = []; % feat temp for both classes and fewer canon subskel
% trajFeatureCurr = [36 37 1063 1060 1067]; % feat temp for both classes and more canon subskel 
trajFeatureCurr = [42 43 44 1061 1051 1079 1060]; % feat temp for only class id 56, more canon subskel
