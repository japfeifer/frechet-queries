...
parfor fi = 1:size(currSet,1)
    ...
    [meanDist,medDist,stddevDist,minDist,maxDist] = GetJointDist3(currSeq,RHND);
    tmpFeat(1,a:a+3) = [meanDist medDist stddevDist maxDist]; a = a + 4;
    [meanDist,medDist,stddevDist,minDist,maxDist] = GetJointDist3(currSeq,LHND);
    tmpFeat(1,a:a+3) = [meanDist medDist stddevDist maxDist]; a = a + 4;
    [meanDist,medDist,stddevDist,minDist,maxDist] = GetJointDist3(currSeq,RFOT);
    tmpFeat(1,a:a+3) = [meanDist medDist stddevDist maxDist]; a = a + 4;
    [meanDist,medDist,stddevDist,minDist,maxDist] = GetJointDist3(currSeq,LFOT);
    tmpFeat(1,a:a+3) = [meanDist medDist stddevDist maxDist]; a = a + 4;
    [meanDist,medDist,stddevDist,minDist,maxDist] = GetJointDist3(currSeq,HEAD);
    tmpFeat(1,a:a+3) = [meanDist medDist stddevDist maxDist]; a = a + 4;
    [meanDist,medDist,stddevDist,minDist,maxDist] = GetJointDist3(currSeq,HIP);
    tmpFeat(1,a:a+3) = [meanDist medDist stddevDist maxDist]; a = a + 4;
    
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,HEAD,NECK,RSHO);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,SHO,RSHO,RELB);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,RSHO,RELB,RWST);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,RELB,RWST,RHND);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,RWST,RHND,RTHM);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,RWST,RHND,RTIP);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,HEAD,NECK,LSHO);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,SHO,LSHO,LELB);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,LSHO,LELB,LWST);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,LELB,LWST,LHND);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,LWST,LHND,LTHM);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,LWST,LHND,LTIP);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,HEAD,NECK,SHO);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,NECK,SHO,SPIN);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,SHO,SPIN,HIP);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,SPIN,HIP,RHIP);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,HIP,RHIP,RKNE);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,RHIP,RKNE,RANK);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,RKNE,RANK,RFOT);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,SPIN,HIP,LHIP);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,HIP,LHIP,LKNE);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,LHIP,LKNE,LANK);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
    [meanAng,medAng,stddevAng,minAng,maxAng] = GetJointAng(currSeq,LKNE,LANK,LFOT);
    tmpFeat(1,a:a+4) = [meanAng medAng stddevAng minAng maxAng]; a = a + 5;
