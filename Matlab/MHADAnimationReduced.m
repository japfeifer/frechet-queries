...
yval = [seq(:,2)' seq(:,5)' seq(:,8)' seq(:,11)' seq(:,14)' seq(:,17)' seq(:,20)' seq(:,23)' seq(:,26)' seq(:,29)' seq(:,32)' seq(:,35)' seq(:,37)' seq(:,41)' seq(:,44)' ];
...
for i = 1:size(seq,1)
    ...
    hold on;
    % 
    plot3(seq(i,4),seq(i,5),seq(i,6),'o','MarkerSize',5,'MarkerFaceColor','k','MarkerEdgeColor','k');
    hold on;
    % 
    ...
    hold on;
    % 
    plot3(seq(i,16),seq(i,17),seq(i,18),'o','MarkerSize',5,'MarkerFaceColor','k','MarkerEdgeColor','k');
    hold on;
    % 
