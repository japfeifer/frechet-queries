...
function seq = UCFNormalizeSeq(seq,seqNormalCurr)
    ...
    if seqNormalCurr(1,1) == 1
        ...
        seq = [seq(:,HEAD)+transPoint seq(:,NECK)+transPoint ...
               seq(:,TORS)+transPoint seq(:,LSHO)+transPoint ...
               seq(:,LELB)+transPoint seq(:,LHND)+transPoint ...
               seq(:,RSHO)+transPoint seq(:,RELB)+transPoint ...
               seq(:,RHND)+transPoint seq(:,LHIP)+transPoint ...
               seq(:,LKNE)+transPoint seq(:,LFOT)+transPoint ...
